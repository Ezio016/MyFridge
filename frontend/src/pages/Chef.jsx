...
`
    ...
    if (type === 'lightning') {
      prompt += `Give me 50 SUPER FAST recipes (UNDER 5 MINUTES, no cooking required or microwave only).
...
Must include at least 2 of my main ingredients. Be creative and diverse!`
      ...
      prompt += `Give me 50 recipes that take 15-45 minutes. More substantial meals with real cooking.
